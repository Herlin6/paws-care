              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Nama', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                      const SizedBox(height: 8),
                      TextField(controller: _nameController, decoration: _deco('Nama lengkap')),
                      ...
                      TextField(
                        ...
                        decoration: _deco('email@contoh.com'),
                      ),
                      const SizedBox(height: 18),
                      ...
                      Row(
                        ...
                        children: [
                          const Text('Sudah punya akun? ', style: TextStyle(fontSize: 13, color: Color(0xFF666666))),
                          GestureDetector(
